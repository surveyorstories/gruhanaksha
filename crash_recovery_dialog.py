...
class CrashRecoveryDialog(QDialog):
    ...
    def _setup_ui(self):
        """Construct a modern, responsive layout."""
        self.setStyleSheet("""
            QDialog {
            ...
            QTabBar::tab:selected {
                background: #FFFFFF;
                font-weight: bold;
                border-color: #0969DA #D0D7DE #FFFFFF #D0D7DE;
        ...
        title_label = QLabel("🛡️ Layer Crash Recovery & Time Travel")
        title_font = QFont()
        ...
        self.lbl_table_stats.setStyleSheet("color: #57606A; font-size: 11px;")
        ...
        self.lbl_preview_info = QLabel(
            "Select a restore point to preview changes")
        ...
        legend_layout.addWidget(
            self._create_legend_badge("🟢 Added", "#2E7D32"))
        legend_layout.addWidget(
            self._create_legend_badge("🔴 Deleted", "#C62828"))
        legend_layout.addWidget(
            self._create_legend_badge("🟠 Modified", "#EF6C00"))
        legend_layout.addWidget(
            self._create_legend_badge("🔵 Unchanged", "#455A64"))
        ...
        self.lbl_slider_time.setStyleSheet(
        ...
        self.btn_selective_restore.setObjectName("primaryBtn")
        ...
        self.btn_restore_as_new.setObjectName("blueBtn")
        ...
        self.btn_restore_inplace.setObjectName("primaryBtn")
    ...
    def _setup_settings_tab(self, parent_widget: QWidget):
        ...
        self.lbl_db_size.setStyleSheet("font-weight: bold; color: #0969DA;")
    ...
    def load_restore_points(self):
        ...
        for row, r in enumerate(records):
            ...
            if tag_text:
                tag_item.setForeground(QColor("#0969DA"))
                font = tag_item.font()
                font.setBold(True)
    ...
    def _render_snapshot_preview(self, snapshot_id: int):
        ...
        def add_category_features(feats_list, status_name, status_color_hex):
            nonlocal row_idx
        ...
        add_category_features(diff_data['added'], "added", "#2E7D32")
        add_category_features(diff_data['modified'], "modified", "#EF6C00")
        add_category_features(diff_data['deleted'], "deleted", "#C62828")
        add_category_features(diff_data['unchanged'], "unchanged", "#455A64")
    ...
    def _apply_diff_styling(self, layer: QgsVectorLayer, geom_type: str):
        ...
        diff_colors = {
            ...
            # Slate
            "unchanged": ("\"_diff_status\" = 'unchanged'", QColor(69, 90, 100, 120), "#455A64")
        }
